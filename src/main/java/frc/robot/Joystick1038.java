...
public class Joystick1038 extends Joystick {
	...
	public boolean getLeftTriggerDigital() {
		return getRawAxis(XboxController.Axis.kLeftTrigger.value) > .2;
	}
	...
	public boolean getRightTriggerDigital() {
		return getRawAxis(XboxController.Axis.kRightTrigger.value) > .2;
	}
	...
	public double getLeftJoystickVertical() {
		return getRawAxis(XboxController.Axis.kLeftY.value) * -1;
	}
	...
	public double getRightJoystickVertical() {
		return getRawAxis(XboxController.Axis.kRightY.value) * -1;
	}
